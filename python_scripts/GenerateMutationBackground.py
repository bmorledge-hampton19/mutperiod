...
def generateMutationBackground(mutationFilePaths, genomeFilePath, backgroundContextNum):
    ...
    for mutationFilePath in mutationFilePaths:
        ...
        mutationContextFrequencyFilePath = os.path.join(workingDirectory,"intermediate_files",
                                                        mutationGroupName+"_" + contextText + "_mutation_frequencies.tsv")

        # Generate the file path for the background mutation rate file.
        mutationBackgroundFilePath = os.path.join(workingDirectory,mutationGroupName + "_" + contextText + "_mutation_background.tsv")
        ...
        if not os.path.exists(genomeContextFrequencyFilePath):
            ...
            generateGenomeContextFrequencyFile(genomeFilePath, genomeContextFrequencyFilePath, backgroundContextNum, contextText)
...
if __name__ == "__main__":
    ...
    generateMutationBackground(mutationFilePaths, genomeFilePath, backgroundContextNum)